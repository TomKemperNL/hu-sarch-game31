	...
	*/
	public void initGUI(){
		try {
			...
			titelPicture.setIcon(new ImageIcon(getClass().getResource("/images/setupInstellingenTitelPic.png")));
			...
			transparantBG.setIcon(new ImageIcon(getClass().getResource("/images/transparant.png")));
			...
			okBG.setIcon(new ImageIcon(getClass().getResource("/images/transparant.png")));
			okButton.add(okBG);
			...
			backgroundPicture.setIcon(new ImageIcon(getClass().getResource("/images/setupBackground.jpg")));
