	...
	*/
	public void initGUI(){
		try {
			...
			bgPictureLabel.setIcon(new ImageIcon(getClass().getClassLoader().getResource("game31/userInterface/images/mainFrameBackground.jpg")));
			...
			transparantVlak4.setIcon(new ImageIcon(getClass().getClassLoader().getResource("game31/userInterface/images/transparant.png")));
			...
			transparantVlak4_1.setIcon(new ImageIcon(getClass().getClassLoader().getResource("game31/userInterface/images/transparant.png")));
			...
			transparantVlak5.setIcon(new ImageIcon(getClass().getClassLoader().getResource("game31/userInterface/images/transparant.png")));
			...
			transparantVlak5_1.setIcon(new ImageIcon(getClass().getClassLoader().getResource("game31/userInterface/images/transparant.png")));
