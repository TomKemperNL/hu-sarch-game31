	...
	*/
	public void initGUI(){
		try {
			...
			okButtonBG.setIcon(new ImageIcon(getClass().getResource("/images/transparant.png")));
			...
			achtergrondAfbeelding.setIcon(new ImageIcon(getClass().getResource("/images/spelerSetupBackground.jpg")));
